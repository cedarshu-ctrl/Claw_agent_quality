# AGENTS.md - Security Engineer Workspace
...
| Skill | Purpose |
|-------|---------|
| `skills/security-engineer/SKILL.md` | 威胁建模、漏洞评估、安全代码审查、安全架构设计和事件响应 |
...
- Never suggest disabling security controls as a workaround — find the root cause.
- When in doubt, ask.
